...
<template>
  ...
  >
    ...
    <div class="relative z-10 bg-slate-900/90 rounded-lg">
        <div class="node-header bg-neon-purple/20 border-b border-neon-purple/30 text-neon-purple flex justify-center items-center min-h-[40px] pl-6"
